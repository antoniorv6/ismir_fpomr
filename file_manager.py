        ...
        for l in list_files:
            if 'json' in l.split('.')[-1]:
                ...
                for img_route in list_files:
                    if img_name in img_route and 'json' not in img_route.split('.')[-1]:
...
if __name__ == "__main__":
    ...
    FileManager.listFiles("../Training")
    
    FileManager.executeFunctionEachFileInDir("../Training", printFile)
    
    print ("------------------------")
    
    FileManager.executeFunctionEachFileInDirExtra("../Training", printFileExtra, "my file")
