...
class DataAugmentationGenerator:
    ...
    @staticmethod
    def generateNewImageRandomAuto(img_orig, json_orig, list_json_pathfiles, vertical_region_resize, uniform_rotate, verbose=False):
        ...
        if (uniform_rotate is True):
            uniform_angle = random.randint(-3,3)
        else:
            uniform_angle = None
        ...
        for key in bboxes_orig:
            ...
            for key_region in bboxes_regions:
                ...
                for bbox_region in bboxes_regions[key_region]:
                    ...
                    selected_patch, selected_region_key = MuretInterface.selectRandomRegion(key_region, dict_regions)
    ...
    @staticmethod 
    def generateNewImageFromListByBoundingBoxesRandomSelectionAuto(json_dataset, number_new_images, uniform_rotate, vertical_region_resize, reduction_factor,  json_dirpath_out=None):
        
        ### PRUEBA
        #json_dataset = '/home/jc/MURETDataAugmentationGen/datasetCapitan/'
        ...
        #print("Dictionary example: ", routes_dict['/home/jc/MURETDataAugmentationGen/datasetCapitan/JSON/b-59-850/12605.jpg.json'])

        if json_dirpath_out is None:
            json_dirpath_out = json_dataset + 'daug/JSON/'
            src_dirpath_out = json_dataset + 'daug/SRC/'
        ...
        for idx_new_image in range(number_new_images):
            ...
            while (with_regions == False):
                ...
                new_img, new_bbox_regions, new_coords, regions_dicts = DataAugmentationGenerator.generateNewImageRandomAuto(blur_img, json_pathfile, list_json_pathfiles, vertical_region_resize, uniform_rotate)
...
if __name__ == "__main__":
    random.seed(42)
    DataAugmentationGenerator.generateNewImageFromListByBoundingBoxesRandomSelectionAuto("datasets/JSON/SEILS/", 1, True, False, 0.3)
    
    # UNCOMMENT THIS: if you want to see the boxes drawed
    #DataAugmentationGenerator.seeBoxes('/home/jc/object_detection_data_augmentation/datasets/daug/SRC/SEILS/0.png', '/home/jc/object_detection_data_augmentation/datasets/daug/JSON/SEILS/0.dict')
